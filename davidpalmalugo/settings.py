...
SECRET_KEY = os.environ.get('SECRET_KEY', 's-26@br@k3midwh714n-@*uhy2-16ly)^q-w8)6o$=j&rr6_^-')
...
ROOT_URLCONF = 'davidpalmalugo.urls'
...
WSGI_APPLICATION = 'davidpalmalugo.wsgi.application'
